...
export function registerSysMLLanguage(monaco) {
  ...
  monaco.languages.setMonarchTokensProvider(LANG_ID, {
    ...
    keywords: [
      ...
      "satisfy", "verify", "allocate", "expose", "to", "by",
      "calc", "constraint", "occurrence", "individual",
    ],
    ...
    provideCompletionItems(model, position) {
      ...
      return {
        suggestions: [
          ...
          snip("action usage",          "action ${1:name} : ${2:Type};"),
          snip("requirement usage",     "requirement ${1:name} : ${2:Type};"),
          snip("attribute",             "attribute ${1:name} : ${2:Type} = $3;"),
          snip("end",                   "end ${1:name} : ${2:Type};"),
          // Relations
          snip("satisfy",               "satisfy ${1:ReqName};"),
          snip("satisfy by",            "satisfy ${1:ReqName} by ${2:ref};"),
          snip("verify",                "verify ${1:ReqName};"),
          snip("allocate to",           "allocate ${1:fn} to ${2:part};"),
          // Modifiers / keywords
          kw("specializes",             "specializes "),
          kw("redefines",               "redefines "),
          kw("subsets",                 "subsets "),
          kw("abstract"),
          kw("doc",                     "doc /* $0 */"),
        ],
